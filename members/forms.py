...
class ProfileForm(forms.ModelForm):
    ...
    accountType = forms.ChoiceField(choices=ACCOUNT_TYPE, widget=forms.Select(attrs={'class':'form-control'}))


    class Meta:
        model = Profile
        fields = ('phoneNumber', 'country', 'accountType')

    def __init__(self, *args, **kwargs):
        super(ProfileForm, self).__init__(*args, **kwargs)

        self.fields['accountType'].label = "Account Type:"
